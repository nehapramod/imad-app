...
app.use(session({
    secret: 'some random value select',
...
app.post('/create-user', function (req, res) {
    ...
    pool.query('INSERT INTO "user1" (username,password) values ($1, $2)', [username, dbString/*is the hashed password*/], function (err, result){
         if(err){
...
app.post('/login', function (req, res){
    var username = req.body.username;
    var password = req.body.password;
    pool.query('SELECT * WHERE "user1" WHERE username = $1', [username], function (err, result){
         if(err){
            res.status(500).send(err.toString());
        }else{
